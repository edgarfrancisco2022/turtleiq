...
import { credentialsSignIn, signInWithGoogle, signInWithFacebook } from './actions'
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
        ...
        <div className="space-y-2 mb-5">
          ...
          <form action={signInWithFacebook}>
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-2 bg-[#1877F2] rounded-lg py-2 text-sm font-medium text-white hover:bg-[#166FE5] transition-colors"
            >
