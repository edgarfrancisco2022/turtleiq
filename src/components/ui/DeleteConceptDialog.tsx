...
export default function DeleteConceptDialog({ conceptName, onConfirm, onCancel }: Props) {
  useEffect(() => {
    ...
    >
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm p-6">
        ...
        <p className="text-sm font-medium text-gray-700 bg-gray-100 rounded px-2 py-1 inline-block mb-4 truncate max-w-full">
          &ldquo;{conceptName}&rdquo;
        </p>
        <p className="text-sm text-gray-500 mb-6 leading-relaxed">
          This concept will be permanently deleted. This action cannot be undone.
        </p>
